(deftheme monstera
  "A personal theme with high contrast and fewer colors")
...
(custom-theme-set-faces
 ...
 '(font-lock-builtin-face ((t (:foreground "#520e9f"))))
 ...
 '(font-lock-keyword-face ((t (:foreground "SeaGreen4" :weight semi-bold))))
 '(font-lock-negation-char-face ((t nil)))
 '(font-lock-preprocessor-face ((t (:inherit (font-lock-builtin-face)))))
 '(font-lock-regexp-grouping-backslash ((t (:inherit (bold)))))
 '(font-lock-regexp-grouping-construct ((t (:inherit (bold)))))
 '(font-lock-string-face ((t (:foreground "#0060cf"))))
 '(font-lock-type-face ((t (:foreground "#078781"))))
 ...
 '(tooltip ((t (:inherit variable-pitch :background "lavender" :foreground "black"))))
 ...
 '(isearch ((t (:background "linen" :foreground "black"))))
 ...
 '(default ((t (:inherit nil :extend nil :stipple nil :background "white" :foreground "black" :inverse-video nil :box nil :strike-through nil :overline nil :underline nil :slant normal :weight normal :height 140 :width normal :foundry "JB" :family "JetBrains Mono")))))

(provide-theme 'monstera)
